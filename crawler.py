...
# 식당 리스트
restaurant_list = driver.find_elements(By.CSS_SELECTOR, 'li.tzwk0')
# 페이지 리스트
...
# for btn in range(len(next_btn))[1:]:  # next_btn[0] = 이전 페이지 버튼 무시 -> [1]부터 시작
#     restaurant_list = driver.find_elements(By.CSS_SELECTOR, 'li.UEzoS')
#     names = driver.find_elements(By.CSS_SELECTOR, '.N_KDL > span ')  # (3) 장소명
...
#             # (5) 주소 버튼 누르기
#             address_buttons = driver.find_elements(By.CSS_SELECTOR, '.Y2sSu')
...
#             addr = driver.find_elements(By.CSS_SELECTOR, '.AbTyi > div.zZfO1')
